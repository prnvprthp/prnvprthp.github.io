...
const techTooltips: Record<string, string> = {
  ...
  "Python": "Primary language for data science, with a rich ecosystem of ML and analytics libraries",
  "Brownian Motion": "Stochastic process modeling random movement, used in financial price simulation",
  "Simulation": "Monte Carlo method that runs thousands of random scenarios to estimate probability distributions",
  ...
  "FRED API": "Federal Reserve Economic Data, providing free, real-time U.S. macroeconomic datasets",
  "TSLM": "Time Series Linear Model that fits regression to sequential time-ordered data in R",
